...
$A(i)$ specifies the set of indices excluding $i$ and $\mathcal{G}_i =\{a\} $ where $i'$ and $g'$ are the original indices of $x_i$ and $x_g$. Also, $\tau \in \mathbb{R}^+$ is a temperature parameter. 
