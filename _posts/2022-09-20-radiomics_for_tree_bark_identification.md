...
*Trukn12* consists of 393 images of tree barks of 12 different trees that can be found in Slovenia. For each tree class, there exists about 30 jpeg images of resolution $3000 \times s4000$ pixels. The images are taken using the same camera Nikon COOLPIX S3000 following the same imaging setup: same distance, light conditions and in an upright position. 
