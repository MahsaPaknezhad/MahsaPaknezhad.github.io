...
To prepare this dataset for radiomics analysis we performed a few preprocessing steps on the images. These preprocessing steps are explained in the following section. 
